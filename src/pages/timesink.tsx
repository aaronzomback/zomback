...
<div className="mt-6">
  ...
  <p>A cinema platform for supporting great filmmakers and connecting audiences.</p>
    <p><a href="https://www.timesinkpresents.com">www.timesinkpresents.com</a></p>
            <a className="twitter-timeline" data-width="282" data-height="120" data-theme="light" href="https://twitter.com/timesink_?ref_src=twsrc%5Etfw">Tweets by timesink_</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
            </div>
